...
def join_object():
    ...
    join_object_thread = Thread(target=_join_object)
    join_object_thread.start()

    return join_object_thread
...
def sensory():
    def _sensory():
        def collect_sensor_values():
            ...
            sensory_values = [{"sensorID": "mr3m_belt_position",
                               "value": motor_position(belt_motor),
                               "datetime": current_time},
                              {"sensorID": "mr3m_catch_position",
                               "value": motor_position(catch_motor),
                               "datetime": current_time},
                              {"sensorID": "mr3m_join_position",
                               "value": motor_position(join_motor),
                               "datetime": current_time},
                              {"sensorID": "mr3s_color_value_h",
                               "value": color_sensor.color().h,
                               "datetime": current_time},
                              {"sensorID": "mr3s_color_value_s",
                               "value": color_sensor.color().s,
                               "datetime": current_time},
                              {"sensorID": "mr3s_color_value_v",
