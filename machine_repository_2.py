...
def sensory():
    ...
    def collect_sensor_values():
        ...
        sensory_values = ujson.dumps([{"sensorID": "r2_m_belt_position",
...
def initialize_threads():
    return [Thread(target=sensory), Thread(target=watch_color), Thread(target=catch_object)]
